...
class AvailabilityBreakDto {
  @ApiProperty({
    description: 'Name of the break (e.g., Lunch)',
    example: 'Lunch',
  })
  @IsString()
  @IsNotEmpty()
...
export class AvailabilityDayDto {
  ...
  @ApiProperty({
    description: 'Indicates if the provider is available on this day',
    example: true,
  })
  @IsBoolean()
  isAvailable: boolean;
  ...
  @ApiProperty({
    required: false,
    description:
      'Work start time in HH:mm format. Required if isAvailable is true.',
    example: '09:00',
  })
  ...
  @ApiProperty({
    required: false,
    description:
      'Work end time in HH:mm format. Required if isAvailable is true.',
    example: '18:00',
  })
  @ValidateIf((o) => o.isAvailable === true)
...
export class UpdateAvailabilityDto {
  @ApiProperty({
    ...
    description:
      'Array containing the configuration for all 7 days of the week.',
  })
  @IsArray()
  @ValidateNested({ each: true })
  @ArrayMinSize(7, {
    message: 'Must provide configuration for all 7 days of the week.',
  })
  @ArrayMaxSize(7, {
    message: 'Must provide configuration for only 7 days of the week.',
  })
  @Type(() => AvailabilityDayDto)
