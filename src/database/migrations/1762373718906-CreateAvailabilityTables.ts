...
export class CreateAvailabilityTables1762373718906 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "services_pricing" ("id" uuid NOT NULL, "name" character varying(255) NOT NULL, "service_id" uuid NOT NULL, "description" text NOT NULL, "priceInCents" integer NOT NULL, "durationInMinutes" integer NOT NULL, "is_active" boolean NOT NULL DEFAULT true, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_b3df714d657b4df8e35fe2c1e44" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "appointment" ADD CONSTRAINT "FK_8bbe73e17a38253534a64f5aa65" FOREIGN KEY ("service_pricing_id") REFERENCES "services_pricing"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
